...
import 'package:jumper/logic/cubits/vendor/vendor_cubit/vendor_cubit.dart';
...
class VendorFormProvider with ChangeNotifier {
  ...
  VendorFormProvider(this.context) {
    _listenToUserCubit();
  }
  ...
  void createAccount() async {
    ...
    BlocProvider.of<VendorCubit>(context).createAccount(
      email: email,
      password: password,
      fullName: fullName,
