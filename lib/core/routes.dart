...
import 'package:jumper/presentation/widgets/vendor/edit_product.dart';
...
class Routes {
  static Route? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      ////////////////Vendors//////////////
      case VendorFormScreen.routeName:
        return CupertinoPageRoute(
            builder: (context) => ChangeNotifierProvider(
                create: (context) => VendorFormProvider(context),
                child: const VendorFormScreen()));

      case VendorsHome.routeName:
        return CupertinoPageRoute(
            builder: (context) => ChangeNotifierProvider(
                create: (context) => AddProductProvider(context),
                child: const VendorsHome()));
      ...
      case EditProduct.routeName:
        return CupertinoPageRoute(builder: (context) => const EditProduct());

      ///////////////Admin/////////////////

      case EditProductDetailsScreen.routeName:
        return CupertinoPageRoute(
            builder: (context) => const EditProductDetailsScreen());
      ...
      case AddVendorScreen.routeName:
        return CupertinoPageRoute(
            builder: (context) => ChangeNotifierProvider(
                create: (context) => AddProductProvider(context),
